const { fit } = require("@jest/globals");
const { default: FavouriteRestaurant } = require("../src/scripts/data/favourite-restaurant");
const { default: FavoriteRestaurantSearchPresenter } = require("../src/scripts/views/pages/favourite-restaurant-presenter");
